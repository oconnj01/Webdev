        ...
        <div class="row" id="topRow">
            <div class="col-sm-12 col-xs-12 col-md-4 col-lg-3 ">
                <div class="thumbnail widget">
					<img src="Images/Images/relaxed.jpg" alt="Picture of red shirt" class="img" id="item"/> 
                </div>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-4 col-lg-3 ">
                <div class="thumbnail widget">
                    <img src="Images/Images/relaxed1.jpg" alt="Picture of green shirt" class="img" />
                </div>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-4 col-lg-3">
                <div class="thumbnail widget">
                    <img src="Images/Images/relaxed2.jpg" alt="Picture of blue shirt" class="img" />   
                </div>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-4 col-lg-3">
                <div class="thumbnail widget">
